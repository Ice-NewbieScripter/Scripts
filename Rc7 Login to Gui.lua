...
Text = "password: Rc7 Cracked By AOC",
...
submit.MouseButton1Down:connect(function()
	if pass.Text == "Rc7 Cracked By AOC" then
...
dex.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Xenon-UI-coder/Script-Universal/main/AOC_Dark-DEX.lua"))()
end)
