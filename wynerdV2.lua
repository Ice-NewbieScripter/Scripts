...
if not getconnections or not hookmetamethod or not getnamecallmethod or not setthreadidentity or not ((getgenv and getgenv()) or _G) then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "wynerdV2",Text = "Executor is not supported!",Duration = 10,})
end
